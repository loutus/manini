...
public static manini.b4a.example.index _index = null;
  public Object[] GetGlobals() {
		return new Object[] {"extra",Debug.moduleToString(manini.b4a.example.extra.class),"HttpUtils2Service",starter.mostCurrent._httputils2service,"index",Debug.moduleToString(manini.b4a.example.index.class),"Main",Debug.moduleToString(manini.b4a.example.main.class),"Service",starter.mostCurrent._service};
}
}