...
try {
		Debug.PushSubsStack("index_draw (index) ","index",3,index.mostCurrent.activityBA,index.mostCurrent,86);
...
Debug.locals.put("flag", _flag);
 BA.debugLineNum = 86;BA.debugLine="Sub index_draw(size As String,flag)";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 87;BA.debugLine="Dim panel As Panel";
Debug.ShouldStop(4194304);
_panel = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");Debug.locals.put("panel", _panel);
 BA.debugLineNum = 88;BA.debugLine="panel.Initialize(\"panel\")";
Debug.ShouldStop(8388608);
_panel.runVoidMethod ("Initialize",index.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("panel")));
 BA.debugLineNum = 89;BA.debugLine="Dim space As Int = 2dip";
Debug.ShouldStop(16777216);
_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("space", _space);Debug.locals.put("space", _space);
 BA.debugLineNum = 90;BA.debugLine="Dim padding_space As Int = 2dip";
Debug.ShouldStop(33554432);
_padding_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("padding_space", _padding_space);Debug.locals.put("padding_space", _padding_space);
 BA.debugLineNum = 91;BA.debugLine="If size=\"larg\" Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",_size,BA.ObjectToString("larg"))) { 
 BA.debugLineNum = 92;BA.debugLine="Dim left_draw As Int = padding_space";
Debug.ShouldStop(134217728);
_left_draw = _padding_space;Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 93;BA.debugLine="Dim width_draw As Int = 100%x - left_draw";
Debug.ShouldStop(268435456);
_width_draw = RemoteObject.solve(new RemoteObject[] {index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 100)),index.mostCurrent.activityBA),_left_draw}, "-",1, 1);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 94;BA.debugLine="Dim shadow_space As Int = 5dip";
Debug.ShouldStop(536870912);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 5)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 95;BA.debugLine="extra.index_ob_olaviyat(flag) = 1";
Debug.ShouldStop(1073741824);
...
index.mostCurrent._extra._index_ob_top_cach = _width_draw;
 BA.debugLineNum = 97;BA.debugLine="panel.Color = Colors.red";
Debug.ShouldStop(1);
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").getField(true,"Red"));
 };
 BA.debugLineNum = 99;BA.debugLine="If size=\"medium\" Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",_size,BA.ObjectToString("medium"))) { 
 BA.debugLineNum = 100;BA.debugLine="Select extra.index_ob_olaviyat(flag-1)";
Debug.ShouldStop(8);
...
case 0: {
 BA.debugLineNum = 102;BA.debugLine="Dim left_draw As Int = 33.2%x + padding_space";
Debug.ShouldStop(32);
_left_draw = RemoteObject.solve(new RemoteObject[] {index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.2)),index.mostCurrent.activityBA),_padding_space}, "+",1, 1);Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 103;BA.debugLine="Dim width_draw As Int = 66%x+ padding_space";
Debug.ShouldStop(64);
_width_draw = RemoteObject.solve(new RemoteObject[] {index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 66)),index.mostCurrent.activityBA),_padding_space}, "+",1, 1);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 104;BA.debugLine="Dim shadow_space As Int = 15dip";
...
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 105;BA.debugLine="extra.index_ob_olaviyat(flag)=224";
...
index.mostCurrent._extra._index_ob_olaviyat.setArrayElement (BA.numberCast(int.class, 224),BA.numberCast(int.class, _flag));
 BA.debugLineNum = 106;BA.debugLine="extra.index_ob_top_cach = 0";
Debug.ShouldStop(512);
index.mostCurrent._extra._index_ob_top_cach = BA.numberCast(int.class, 0);
 BA.debugLineNum = 107;BA.debugLine="panel.Color = Colors.Green";
Debug.ShouldStop(1024);
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"));
 break; }
case 1: {
 BA.debugLineNum = 109;BA.debugLine="Dim left_draw As Int = 66.4%x  + padding_space";
...
_left_draw = RemoteObject.solve(new RemoteObject[] {index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 66.4)),index.mostCurrent.activityBA),_padding_space}, "+",1, 1);Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 110;BA.debugLine="Dim width_draw As Int = 33.2%x";
...
_width_draw = index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.2)),index.mostCurrent.activityBA);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 111;BA.debugLine="Dim shadow_space As Int = 15dip";
Debug.ShouldStop(16384);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 112;BA.debugLine="extra.index_ob_top_cach =  width_draw";
Debug.ShouldStop(32768);
index.mostCurrent._extra._index_ob_top_cach = _width_draw;
 BA.debugLineNum = 113;BA.debugLine="panel.Color = Colors.Blue";
Debug.ShouldStop(65536);
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"));
 break; }
case 2: {
 BA.debugLineNum = 115;BA.debugLine="Dim left_draw As Int = 33.2%x + padding_space";
Debug.ShouldStop(262144);
_left_draw = RemoteObject.solve(new RemoteObject[] {index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.2)),index.mostCurrent.activityBA),_padding_space}, "+",1, 1);Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 116;BA.debugLine="Dim width_draw As Int = 66%x+ padding_space";
Debug.ShouldStop(524288);
_width_draw = RemoteObject.solve(new RemoteObject[] {index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 66)),index.mostCurrent.activityBA),_padding_space}, "+",1, 1);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 117;BA.debugLine="Dim shadow_space As Int = 15dip";
Debug.ShouldStop(1048576);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 118;BA.debugLine="extra.index_ob_olaviyat(flag)=222";
Debug.ShouldStop(2097152);
index.mostCurrent._extra._index_ob_olaviyat.setArrayElement (BA.numberCast(int.class, 222),BA.numberCast(int.class, _flag));
 BA.debugLineNum = 119;BA.debugLine="extra.index_ob_top_cach = 0";
Debug.ShouldStop(4194304);
index.mostCurrent._extra._index_ob_top_cach = BA.numberCast(int.class, 0);
 BA.debugLineNum = 120;BA.debugLine="panel.Color = Colors.Green";
Debug.ShouldStop(8388608);
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"));
 break; }
case 3: {
 BA.debugLineNum = 122;BA.debugLine="Dim left_draw As Int = padding_space";
Debug.ShouldStop(33554432);
_left_draw = _padding_space;Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 123;BA.debugLine="Dim width_draw As Int = 66.4%x";
Debug.ShouldStop(67108864);
_width_draw = index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 66.4)),index.mostCurrent.activityBA);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 124;BA.debugLine="Dim shadow_space As Int = 15dip";
Debug.ShouldStop(134217728);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 125;BA.debugLine="extra.index_ob_olaviyat(flag)=22";
Debug.ShouldStop(268435456);
index.mostCurrent._extra._index_ob_olaviyat.setArrayElement (BA.numberCast(int.class, 22),BA.numberCast(int.class, _flag));
 BA.debugLineNum = 126;BA.debugLine="extra.index_ob_top_cach = 0";
Debug.ShouldStop(536870912);
index.mostCurrent._extra._index_ob_top_cach = BA.numberCast(int.class, 0);
 BA.debugLineNum = 127;BA.debugLine="panel.Color = Colors.red";
Debug.ShouldStop(1073741824);
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").getField(true,"Red"));
 break; }
}
;
 ...
 BA.debugLineNum = 130;BA.debugLine="If size=\"small\" Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean("=",_size,BA.ObjectToString("small"))) { 
 BA.debugLineNum = 132;BA.debugLine="Select extra.index_ob_olaviyat(flag-1)";
Debug.ShouldStop(8);
...
case 0: {
 BA.debugLineNum = 134;BA.debugLine="Dim left_draw As Int =  padding_space";
Debug.ShouldStop(32);
_left_draw = _padding_space;Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
...
Debug.ShouldStop(128);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 137;BA.debugLine="extra.index_ob_top = extra.index_ob_top";
Debug.ShouldStop(256);
index.mostCurrent._extra._index_ob_top = index.mostCurrent._extra._index_ob_top;
 BA.debugLineNum = 138;BA.debugLine="extra.index_ob_olaviyat(flag)=1";
Debug.ShouldStop(512);
index.mostCurrent._extra._index_ob_olaviyat.setArrayElement (BA.numberCast(int.class, 1),BA.numberCast(int.class, _flag));
 BA.debugLineNum = 139;BA.debugLine="extra.index_ob_top_cach = width_draw";
Debug.ShouldStop(1024);
index.mostCurrent._extra._index_ob_top_cach = _width_draw;
 BA.debugLineNum = 140;BA.debugLine="panel.Color = Colors.rgb(255, 51, 0) ' range";
...
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 255)),(Object)(BA.numberCast(int.class, 51)),(Object)(BA.numberCast(int.class, 0))));
 break; }
case 1: {
 BA.debugLineNum = 143;BA.debugLine="Dim left_draw As Int =  padding_space";
Debug.ShouldStop(16384);
_left_draw = _padding_space;Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 144;BA.debugLine="Dim width_draw As Int = 33.2%x";
Debug.ShouldStop(32768);
_width_draw = index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.2)),index.mostCurrent.activityBA);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 145;BA.debugLine="Dim shadow_space As Int = 15dip";
Debug.ShouldStop(65536);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 146;BA.debugLine="extra.index_ob_top = extra.index_ob_top";
Debug.ShouldStop(131072);
index.mostCurrent._extra._index_ob_top = index.mostCurrent._extra._index_ob_top;
 BA.debugLineNum = 147;BA.debugLine="extra.index_ob_olaviyat(flag)=225";
Debug.ShouldStop(262144);
index.mostCurrent._extra._index_ob_olaviyat.setArrayElement (BA.numberCast(int.class, 225),BA.numberCast(int.class, _flag));
 BA.debugLineNum = 148;BA.debugLine="extra.index_ob_top_cach = width_draw";
Debug.ShouldStop(524288);
index.mostCurrent._extra._index_ob_top_cach = _width_draw;
 BA.debugLineNum = 149;BA.debugLine="panel.Color = Colors.rgb(0, 51, 0) ' green";
Debug.ShouldStop(1048576);
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 51)),(Object)(BA.numberCast(int.class, 0))));
 break; }
case 2: {
 BA.debugLineNum = 151;BA.debugLine="Dim left_draw As Int =  padding_space";
Debug.ShouldStop(4194304);
_left_draw = _padding_space;Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 152;BA.debugLine="Dim width_draw As Int = 33.2%x";
Debug.ShouldStop(8388608);
_width_draw = index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.2)),index.mostCurrent.activityBA);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 153;BA.debugLine="Dim shadow_space As Int = 15dip";
Debug.ShouldStop(16777216);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 154;BA.debugLine="extra.index_ob_top = extra.index_ob_top";
Debug.ShouldStop(33554432);
index.mostCurrent._extra._index_ob_top = index.mostCurrent._extra._index_ob_top;
 BA.debugLineNum = 155;BA.debugLine="extra.index_ob_olaviyat(flag)=1";
Debug.ShouldStop(67108864);
index.mostCurrent._extra._index_ob_olaviyat.setArrayElement (BA.numberCast(int.class, 1),BA.numberCast(int.class, _flag));
 BA.debugLineNum = 156;BA.debugLine="extra.index_ob_top_cach = width_draw";
Debug.ShouldStop(134217728);
index.mostCurrent._extra._index_ob_top_cach = _width_draw;
 BA.debugLineNum = 157;BA.debugLine="panel.Color = Colors.rgb(255, 255, 102) ' yell";
Debug.ShouldStop(268435456);
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 255)),(Object)(BA.numberCast(int.class, 255)),(Object)(BA.numberCast(int.class, 102))));
 break; }
case 3: {
 BA.debugLineNum = 159;BA.debugLine="Dim left_draw As Int =  padding_space";
Debug.ShouldStop(1073741824);
_left_draw = _padding_space;Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 160;BA.debugLine="Dim width_draw As Int = 33.2%x";
Debug.ShouldStop(-2147483648);
_width_draw = index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.2)),index.mostCurrent.activityBA);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 161;BA.debugLine="Dim shadow_space As Int = 15dip";
Debug.ShouldStop(1);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 162;BA.debugLine="extra.index_ob_top = extra.index_ob_top + 33.2";
Debug.ShouldStop(2);
index.mostCurrent._extra._index_ob_top = RemoteObject.solve(new RemoteObject[] {index.mostCurrent._extra._index_ob_top,index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.2)),index.mostCurrent.activityBA)}, "+",1, 1);
 BA.debugLineNum = 163;BA.debugLine="extra.index_ob_olaviyat(flag)=223";
Debug.ShouldStop(4);
index.mostCurrent._extra._index_ob_olaviyat.setArrayElement (BA.numberCast(int.class, 223),BA.numberCast(int.class, _flag));
 BA.debugLineNum = 164;BA.debugLine="extra.index_ob_top_cach = 0";
Debug.ShouldStop(8);
index.mostCurrent._extra._index_ob_top_cach = BA.numberCast(int.class, 0);
 BA.debugLineNum = 165;BA.debugLine="panel.Color = Colors.red";
Debug.ShouldStop(16);
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").getField(true,"Red"));
 break; }
case 4: {
 BA.debugLineNum = 167;BA.debugLine="Dim left_draw As Int = 66.4%x  + padding_space";
Debug.ShouldStop(64);
_left_draw = RemoteObject.solve(new RemoteObject[] {index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 66.4)),index.mostCurrent.activityBA),_padding_space}, "+",1, 1);Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 168;BA.debugLine="Dim width_draw As Int = 33.23%x";
Debug.ShouldStop(128);
_width_draw = index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.23)),index.mostCurrent.activityBA);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 169;BA.debugLine="Dim shadow_space As Int = 15dip";
Debug.ShouldStop(256);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 170;BA.debugLine="extra.index_ob_top = extra.index_ob_top + 33.2";
Debug.ShouldStop(512);
index.mostCurrent._extra._index_ob_top = RemoteObject.solve(new RemoteObject[] {index.mostCurrent._extra._index_ob_top,index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.2)),index.mostCurrent.activityBA)}, "+",1, 1);
 BA.debugLineNum = 171;BA.debugLine="extra.index_ob_olaviyat(flag)=1";
Debug.ShouldStop(1024);
index.mostCurrent._extra._index_ob_olaviyat.setArrayElement (BA.numberCast(int.class, 1),BA.numberCast(int.class, _flag));
 BA.debugLineNum = 172;BA.debugLine="extra.index_ob_top_cach = width_draw";
Debug.ShouldStop(2048);
index.mostCurrent._extra._index_ob_top_cach = _width_draw;
 BA.debugLineNum = 173;BA.debugLine="panel.Color = Colors.Green";
Debug.ShouldStop(4096);
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"));
 break; }
case 5: {
 BA.debugLineNum = 175;BA.debugLine="Dim left_draw As Int = 66.4%x  + padding_space";
Debug.ShouldStop(16384);
_left_draw = RemoteObject.solve(new RemoteObject[] {index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 66.4)),index.mostCurrent.activityBA),_padding_space}, "+",1, 1);Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 176;BA.debugLine="Dim width_draw As Int = 33.2%x";
Debug.ShouldStop(32768);
_width_draw = index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.2)),index.mostCurrent.activityBA);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 177;BA.debugLine="Dim shadow_space As Int = 15dip";
Debug.ShouldStop(65536);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 178;BA.debugLine="extra.index_ob_olaviyat(flag)=221";
Debug.ShouldStop(131072);
index.mostCurrent._extra._index_ob_olaviyat.setArrayElement (BA.numberCast(int.class, 221),BA.numberCast(int.class, _flag));
 BA.debugLineNum = 179;BA.debugLine="extra.index_ob_top_cach = 0";
Debug.ShouldStop(262144);
index.mostCurrent._extra._index_ob_top_cach = BA.numberCast(int.class, 0);
 BA.debugLineNum = 180;BA.debugLine="panel.Color = Colors.Blue";
Debug.ShouldStop(524288);
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"));
 break; }
case 6: {
 BA.debugLineNum = 182;BA.debugLine="Dim left_draw As Int = 66.4%x  + padding_space";
Debug.ShouldStop(2097152);
_left_draw = RemoteObject.solve(new RemoteObject[] {index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 66.4)),index.mostCurrent.activityBA),_padding_space}, "+",1, 1);Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 183;BA.debugLine="Dim width_draw As Int = 33.2%x";
Debug.ShouldStop(4194304);
_width_draw = index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.2)),index.mostCurrent.activityBA);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 184;BA.debugLine="Dim shadow_space As Int = 15dip";
Debug.ShouldStop(8388608);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 185;BA.debugLine="extra.index_ob_olaviyat(flag)=1";
Debug.ShouldStop(16777216);
index.mostCurrent._extra._index_ob_olaviyat.setArrayElement (BA.numberCast(int.class, 1),BA.numberCast(int.class, _flag));
 BA.debugLineNum = 186;BA.debugLine="extra.index_ob_top_cach =  width_draw";
Debug.ShouldStop(33554432);
index.mostCurrent._extra._index_ob_top_cach = _width_draw;
 BA.debugLineNum = 187;BA.debugLine="panel.Color = Colors.rgb(255, 102, 255)";
Debug.ShouldStop(67108864);
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").runMethod(true,"RGB",(Object)(BA.numberCast(int.class, 255)),(Object)(BA.numberCast(int.class, 102)),(Object)(BA.numberCast(int.class, 255))));
 break; }
case 7: {
 BA.debugLineNum = 189;BA.debugLine="Dim left_draw As Int = 33.3%x + padding_space";
Debug.ShouldStop(268435456);
_left_draw = RemoteObject.solve(new RemoteObject[] {index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.3)),index.mostCurrent.activityBA),_padding_space}, "+",1, 1);Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 190;BA.debugLine="Dim width_draw As Int = 33.2%x";
Debug.ShouldStop(536870912);
_width_draw = index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.2)),index.mostCurrent.activityBA);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 191;BA.debugLine="Dim shadow_space As Int = 15dip";
Debug.ShouldStop(1073741824);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 192;BA.debugLine="extra.index_ob_olaviyat(flag)=111";
Debug.ShouldStop(-2147483648);
index.mostCurrent._extra._index_ob_olaviyat.setArrayElement (BA.numberCast(int.class, 111),BA.numberCast(int.class, _flag));
 BA.debugLineNum = 193;BA.debugLine="extra.index_ob_top_cach = 0";
Debug.ShouldStop(1);
index.mostCurrent._extra._index_ob_top_cach = BA.numberCast(int.class, 0);
 BA.debugLineNum = 194;BA.debugLine="panel.Color = Colors.Black";
Debug.ShouldStop(2);
_panel.runVoidMethod ("setColor",index.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 break; }
case 8: {
 BA.debugLineNum = 196;BA.debugLine="Dim left_draw As Int = padding_space";
Debug.ShouldStop(8);
_left_draw = _padding_space;Debug.locals.put("left_draw", _left_draw);Debug.locals.put("left_draw", _left_draw);
 BA.debugLineNum = 197;BA.debugLine="Dim width_draw As Int = 33.2%x";
Debug.ShouldStop(16);
_width_draw = index.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 33.2)),index.mostCurrent.activityBA);Debug.locals.put("width_draw", _width_draw);Debug.locals.put("width_draw", _width_draw);
 BA.debugLineNum = 198;BA.debugLine="Dim shadow_space As Int = 15dip";
Debug.ShouldStop(32);
_shadow_space = index.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)));Debug.locals.put("shadow_space", _shadow_space);Debug.locals.put("shadow_space", _shadow_space);
 BA.debugLineNum = 199;BA.debugLine="extra.index_ob_olaviyat(flag)=11";
Debug.ShouldStop(64);
index.mostCurrent._extra._index_ob_olaviyat.setArrayElement (BA.numberCast(int.class, 11),BA.numberCast(int.class, _flag));
 BA.debugLineNum = 200;BA.debugLine="extra.index_ob_top_cach = 0";
Debug.ShouldStop(128);
index.mostCurrent._extra._index_ob_top_cach = BA.numberCast(int.class, 0);
 BA.debugLineNum = 201;BA.debugLine="panel.Color = Colors.DarkGray";
Debug.ShouldStop(256);
...
;
 ...
 BA.debugLineNum = 206;BA.debugLine="Dim cd As ColorDrawable";
Debug.ShouldStop(8192);
_cd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.ColorDrawable");Debug.locals.put("cd", _cd);
 BA.debugLineNum = 209;BA.debugLine="index_ScrollView.Panel.AddView(panel,left_draw,ex";
Debug.ShouldStop(65536);
index.mostCurrent._index_scrollview.runMethod(false,"getPanel").runVoidMethod ("AddView",(Object)((_panel.getObject())),(Object)(_left_draw),(Object)(RemoteObject.solve(new RemoteObject[] {index.mostCurrent._extra._index_ob_top,_space}, "+",1, 1)),(Object)(RemoteObject.solve(new RemoteObject[] {_width_draw,_space}, "-",1, 1)),(Object)(RemoteObject.solve(new RemoteObject[] {_width_draw,_space}, "-",1, 1)));
 BA.debugLineNum = 210;BA.debugLine="extra.index_ob_top = extra.index_ob_top + extra.i";
Debug.ShouldStop(131072);
index.mostCurrent._extra._index_ob_top = RemoteObject.solve(new RemoteObject[] {index.mostCurrent._extra._index_ob_top,index.mostCurrent._extra._index_ob_top_cach}, "+",1, 1);
 BA.debugLineNum = 211;BA.debugLine="index_ScrollView.Panel.Height = extra.index_ob_to";
Debug.ShouldStop(262144);
...
index.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.concat(index.mostCurrent._extra._image_address,index.mostCurrent._index_retrive_list.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 2))))));
 BA.debugLineNum = 41;BA.debugLine="For  i = 1 To 11";
Debug.ShouldStop(256);
{
final int step7 = 1;
final int limit7 = 11;
