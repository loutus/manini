...
mostCurrent._header_title.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 261;BA.debugLine="header_title.Gravity = Gravity.RIGHT";
...
mostCurrent._header_title.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 266;BA.debugLine="product_header.AddView(header_title,0,5dip,95%x,4";
...
mostCurrent._lbl_titlen.setText(BA.ObjectToCharSequence(_model));
 //BA.debugLineNum = 350;BA.debugLine="header_title.Text = name";
mostCurrent._header_title.setText(BA.ObjectToCharSequence(_name));
 //BA.debugLineNum = 351;BA.debugLine="extra.product_title = name";
mostCurrent._extra._product_title = _name;
 //BA.debugLineNum = 352;BA.debugLine="total.Text = price.SubString2(0,price.IndexOf";
mostCurrent._total.setText(BA.ObjectToCharSequence(_price.substring((int) (0),_price.indexOf("."))+" "+"تومان"));
			...
			processBA.setLastException(e32); //BA.debugLineNum = 356;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
 };
 //BA.debugLineNum = 358;BA.debugLine="Try";
try { //BA.debugLineNum = 359;BA.debugLine="If  job.JobName.SubString2(0,9)=\"imageview\" The";
if ((_job._jobname.substring((int) (0),(int) (9))).equals("imageview")) { 
 //BA.debugLineNum = 360;BA.debugLine="Dim indexf As Int";
_indexf = 0;
 //BA.debugLineNum = 361;BA.debugLine="Dim name As String";
_name = "";
 //BA.debugLineNum = 362;BA.debugLine="indexf = job.JobName.SubString2(job.JobName.In";
_indexf = (int)(Double.parseDouble(_job._jobname.substring((int) (_job._jobname.indexOf("*")+1),_job._jobname.lastIndexOf("*"))));
 //BA.debugLineNum = 363;BA.debugLine="name = job.JobName.SubString(job.JobName.LastI";
_name = _job._jobname.substring((int) (_job._jobname.lastIndexOf("/")+1));
 //BA.debugLineNum = 364;BA.debugLine="Dim OutStream As OutputStream";
_outstream = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
 //BA.debugLineNum = 365;BA.debugLine="OutStream = File.OpenOutput(File.DirInternalCa";
_outstream = anywheresoftware.b4a.keywords.Common.File.OpenOutput(anywheresoftware.b4a.keywords.Common.File.getDirInternalCache(),_name,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 366;BA.debugLine="File.Copy2(job.GetInputStream,OutStream)";
anywheresoftware.b4a.keywords.Common.File.Copy2((java.io.InputStream)(_job._getinputstream().getObject()),(java.io.OutputStream)(_outstream.getObject()));
 //BA.debugLineNum = 367;BA.debugLine="OutStream.Close";
_outstream.Close();
 //BA.debugLineNum = 368;BA.debugLine="ImageView(indexf).Bitmap = LoadBitmap(File.Dir";
mostCurrent._imageview[_indexf].setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirInternalCache(),_name).getObject()));
			...
			processBA.setLastException(e47); //BA.debugLineNum = 375;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
 };
 //BA.debugLineNum = 377;BA.debugLine="If job.JobName = \"load_category_main\" Then";
if ((_job._jobname).equals("load_category_main")) { 
 //BA.debugLineNum = 378;BA.debugLine="Dim left As Int=15dip";
_left = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (15));
 //BA.debugLineNum = 379;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 380;BA.debugLine="parser.Initialize(job.GetString)";
_parser.Initialize(_job._getstring());
 //BA.debugLineNum = 381;BA.debugLine="Dim root As List = parser.NextArray";
_root = new anywheresoftware.b4a.objects.collections.List();
_root = _parser.NextArray();
 //BA.debugLineNum = 382;BA.debugLine="For Each colroot As Map In root";
_colroot = new anywheresoftware.b4a.objects.collections.Map();
{
...
_colroot.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(group54.Get(index54)));
 //BA.debugLineNum = 383;BA.debugLine="Dim id As String = colroot.Get(\"id\")";
_id = BA.ObjectToString(_colroot.Get((Object)("id")));
 //BA.debugLineNum = 384;BA.debugLine="Dim text As String = colroot.Get(\"name\")";
_text = BA.ObjectToString(_colroot.Get((Object)("name")));
 //BA.debugLineNum = 385;BA.debugLine="Dim lable As Label";
_lable = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 386;BA.debugLine="lable.Initialize(\"lable\")";
_lable.Initialize(mostCurrent.activityBA,"lable");
 //BA.debugLineNum = 387;BA.debugLine="lable.Color = Colors.rgb(102, 187, 106)";
_lable.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (102),(int) (187),(int) (106)));
 //BA.debugLineNum = 388;BA.debugLine="lable.TextColor = Colors.White";
_lable.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 389;BA.debugLine="lable.Gravity = Gravity.CENTER";
_lable.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 390;BA.debugLine="lable.Typeface = Typeface.LoadFromAssets(\"yeka";
_lable.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("yekan.ttf"));
 //BA.debugLineNum = 391;BA.debugLine="lable.TextSize = \"20\"";
_lable.setTextSize((float)(Double.parseDouble("20")));
 //BA.debugLineNum = 392;BA.debugLine="lable.Text = text";
_lable.setText(BA.ObjectToCharSequence(_text));
 //BA.debugLineNum = 393;BA.debugLine="category_hscrollview.Panel.AddView(lable,left,";
mostCurrent._category_hscrollview.getPanel().AddView((android.view.View)(_lable.getObject()),_left,anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2.5)),(int) ((_text.length()*30)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (45)));
 //BA.debugLineNum = 394;BA.debugLine="left =( text.Length * 30  ) + left +8dip";
...
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 397;BA.debugLine="r.Target = category_hscrollview";
_r.Target = (Object)(mostCurrent._category_hscrollview.getObject());
 //BA.debugLineNum = 398;BA.debugLine="r.RunMethod2(\"setHorizontalScrollBarEnabled\", F";
_r.RunMethod2("setHorizontalScrollBarEnabled",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.False),"java.lang.boolean");
 //BA.debugLineNum = 399;BA.debugLine="r.RunMethod2(\"setOverScrollMode\", 2, \"java.lang";
_r.RunMethod2("setOverScrollMode",BA.NumberToString(2),"java.lang.int");
 //BA.debugLineNum = 401;BA.debugLine="category_hscrollview.Panel.Width = left";
mostCurrent._category_hscrollview.getPanel().setWidth(_left);
 //BA.debugLineNum = 402;BA.debugLine="category_hscrollview.FullScroll(True)";
mostCurrent._category_hscrollview.FullScroll(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 403;BA.debugLine="category_hscrollview.ScrollPosition = 50dip";
mostCurrent._category_hscrollview.setScrollPosition(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 };
 //BA.debugLineNum = 405;BA.debugLine="If job.JobName=\"lastproduct\" Then";
if ((_job._jobname).equals("lastproduct")) { 
 //BA.debugLineNum = 406;BA.debugLine="Dim left As Int=15dip";
_left = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (15));
 //BA.debugLineNum = 407;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
 //BA.debugLineNum = 408;BA.debugLine="parser.Initialize(job.GetString)";
_parser.Initialize(_job._getstring());
 //BA.debugLineNum = 409;BA.debugLine="Dim indexf As Int = 1";
_indexf = (int) (1);
 //BA.debugLineNum = 410;BA.debugLine="Dim root As List = parser.NextArray";
_root = new anywheresoftware.b4a.objects.collections.List();
_root = _parser.NextArray();
 //BA.debugLineNum = 411;BA.debugLine="For Each colroot As Map In root";
_colroot = new anywheresoftware.b4a.objects.collections.Map();
{
final anywheresoftware.b4a.BA.IterableList group82 = _root;
final int groupLen82 = group82.getSize()
;int index82 = 0;
;
for (; index82 < groupLen82;index82++){
_colroot.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(group82.Get(index82)));
 //BA.debugLineNum = 412;BA.debugLine="Dim image As String = colroot.Get(\"image\")";
_image = BA.ObjectToString(_colroot.Get((Object)("image")));
 //BA.debugLineNum = 413;BA.debugLine="Dim price As String = colroot.Get(\"price\")";
_price = BA.ObjectToString(_colroot.Get((Object)("price")));
 //BA.debugLineNum = 414;BA.debugLine="Dim model As String = colroot.Get(\"model\")";
_model = BA.ObjectToString(_colroot.Get((Object)("model")));
 //BA.debugLineNum = 415;BA.debugLine="Dim name As String = colroot.Get(\"name\")";
_name = BA.ObjectToString(_colroot.Get((Object)("name")));
 //BA.debugLineNum = 416;BA.debugLine="Dim id As String = colroot.Get(\"id\")";
_id = BA.ObjectToString(_colroot.Get((Object)("id")));
 //BA.debugLineNum = 417;BA.debugLine="Dim panel As Panel";
_panel = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 418;BA.debugLine="panel.Initialize(\"lastproduct_panel\")";
_panel.Initialize(mostCurrent.activityBA,"lastproduct_panel");
 //BA.debugLineNum = 419;BA.debugLine="panel.Tag = id";
_panel.setTag((Object)(_id));
 //BA.debugLineNum = 420;BA.debugLine="panel.Color = Colors.White";
_panel.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 421;BA.debugLine="scrollview_lastproduct.Panel.AddView(panel,lef";
mostCurrent._scrollview_lastproduct.getPanel().AddView((android.view.View)(_panel.getObject()),_left,(int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (160)),(int) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (225))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))));
 //BA.debugLineNum = 422;BA.debugLine="extra.InitPanel(panel,1dip,Colors.White,Colors";
mostCurrent._extra._initpanel(mostCurrent.activityBA,_panel,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))),anywheresoftware.b4a.keywords.Common.Colors.White,anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (207),(int) (204),(int) (204)));
 //BA.debugLineNum = 423;BA.debugLine="Dim lable As Label";
_lable = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 424;BA.debugLine="lable.Initialize(\"lable\")";
_lable.Initialize(mostCurrent.activityBA,"lable");
 //BA.debugLineNum = 425;BA.debugLine="lable.Color = Colors.White";
_lable.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 426;BA.debugLine="lable.TextColor = Colors.rgb(65, 65, 65)";
_lable.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (65),(int) (65),(int) (65)));
 //BA.debugLineNum = 427;BA.debugLine="lable.Gravity = Gravity.RIGHT";
_lable.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.RIGHT);
 //BA.debugLineNum = 428;BA.debugLine="lable.Typeface = Typeface.LoadFromAssets(\"yeka";
_lable.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("yekan.ttf"));
 //BA.debugLineNum = 429;BA.debugLine="lable.TextSize = \"16\"";
_lable.setTextSize((float)(Double.parseDouble("16")));
 //BA.debugLineNum = 430;BA.debugLine="lable.Text = name";
_lable.setText(BA.ObjectToCharSequence(_name));
 //BA.debugLineNum = 431;BA.debugLine="scrollview_lastproduct.Panel.AddView(lable,lef";
mostCurrent._scrollview_lastproduct.getPanel().AddView((android.view.View)(_lable.getObject()),(int) (_left+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (170)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (140)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)));
 //BA.debugLineNum = 433;BA.debugLine="Dim lable2 As Label";
_lable2 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 434;BA.debugLine="lable2.Initialize(\"lable2\")";
_lable2.Initialize(mostCurrent.activityBA,"lable2");
 //BA.debugLineNum = 435;BA.debugLine="lable2.Color = Colors.White";
_lable2.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 436;BA.debugLine="lable2.TextColor = Colors.rgb(102, 187, 106)";
_lable2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (102),(int) (187),(int) (106)));
 //BA.debugLineNum = 437;BA.debugLine="lable2.Typeface = Typeface.DEFAULT_BOLD";
_lable2.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD);
 //BA.debugLineNum = 438;BA.debugLine="lable2.Gravity = Gravity.LEFT";
_lable2.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.LEFT);
 //BA.debugLineNum = 439;BA.debugLine="lable2.Gravity = Gravity.CENTER_VERTICAL";
_lable2.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL);
 //BA.debugLineNum = 440;BA.debugLine="lable2.Typeface = Typeface.LoadFromAssets(\"yek";
_lable2.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("yekan.ttf"));
 //BA.debugLineNum = 441;BA.debugLine="lable2.TextSize = \"16\"";
_lable2.setTextSize((float)(Double.parseDouble("16")));
 //BA.debugLineNum = 442;BA.debugLine="lable2.Text = price";
_lable2.setText(BA.ObjectToCharSequence(_price));
 //BA.debugLineNum = 443;BA.debugLine="scrollview_lastproduct.Panel.AddView(lable2,le";
mostCurrent._scrollview_lastproduct.getPanel().AddView((android.view.View)(_lable2.getObject()),(int) (_left+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (15))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (195)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (125)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (24)));
 //BA.debugLineNum = 445;BA.debugLine="ImageView(indexf).Initialize(\"ImageView\")";
mostCurrent._imageview[_indexf].Initialize(mostCurrent.activityBA,"ImageView");
 //BA.debugLineNum = 446;BA.debugLine="If File.Exists(File.DirInternalCache, image.Su";
...
mostCurrent._imageview[_indexf].setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirInternalCache(),_image.substring((int) (_image.lastIndexOf("/")+1),_image.length())).getObject()));
 ...
 //BA.debugLineNum = 449;BA.debugLine="ImageView(indexf).Bitmap = LoadBitmap(File.Di";
mostCurrent._imageview[_indexf].setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"fileset/main_defult_product.jpg").getObject()));
 //BA.debugLineNum = 450;BA.debugLine="extra.main_download_image(indexf,image)";
mostCurrent._extra._main_download_image(mostCurrent.activityBA,BA.NumberToString(_indexf),_image);
 };
 //BA.debugLineNum = 452;BA.debugLine="ImageView(indexf).Gravity = Gravity.FILL";
mostCurrent._imageview[_indexf].setGravity(anywheresoftware.b4a.keywords.Common.Gravity.FILL);
 //BA.debugLineNum = 453;BA.debugLine="scrollview_lastproduct.Panel.AddView(ImageView";
mostCurrent._scrollview_lastproduct.getPanel().AddView((android.view.View)(mostCurrent._imageview[_indexf].getObject()),(int) (_left+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)),(int) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (157))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))),(int) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (157))-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))));
 //BA.debugLineNum = 455;BA.debugLine="Dim CanvasGraph As Canvas";
_canvasgraph = new anywheresoftware.b4a.objects.drawable.CanvasWrapper();
 //BA.debugLineNum = 456;BA.debugLine="CanvasGraph.Initialize(panel)";
_canvasgraph.Initialize((android.view.View)(_panel.getObject()));
 //BA.debugLineNum = 458;BA.debugLine="CanvasGraph.DrawLine(0,140dip,160dip,140dip,Co";
_canvasgraph.DrawLine((float) (0),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (140))),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (160))),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (140))),anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (207),(int) (204),(int) (204)),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))));
 //BA.debugLineNum = 459;BA.debugLine="left = left + 170dip";
_left = (int) (_left+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (170)));
 //BA.debugLineNum = 460;BA.debugLine="indexf= indexf + 1";
_indexf = (int) (_indexf+1);
 }
};
 //BA.debugLineNum = 462;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 463;BA.debugLine="r.Target = scrollview_lastproduct";
_r.Target = (Object)(mostCurrent._scrollview_lastproduct.getObject());
 //BA.debugLineNum = 464;BA.debugLine="r.RunMethod2(\"setHorizontalScrollBarEnabled\", F";
_r.RunMethod2("setHorizontalScrollBarEnabled",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.False),"java.lang.boolean");
 //BA.debugLineNum = 465;BA.debugLine="r.RunMethod2(\"setOverScrollMode\", 2, \"java.lang";
_r.RunMethod2("setOverScrollMode",BA.NumberToString(2),"java.lang.int");
 //BA.debugLineNum = 466;BA.debugLine="scrollview_lastproduct.Panel.Width = left";
mostCurrent._scrollview_lastproduct.getPanel().setWidth(_left);
 //BA.debugLineNum = 467;BA.debugLine="product_ScrollView.Panel.Height = 50%x+164.5dip";
...
anywheresoftware.b4a.objects.PanelWrapper _lastproduct_panel = null;
 //BA.debugLineNum = 477;BA.debugLine="Sub lastproduct_panel_click()";
 //BA.debugLineNum = 478;BA.debugLine="Dim lastproduct_panel As Panel";
_lastproduct_panel = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 479;BA.debugLine="lastproduct_panel = Sender";
...
int _lener = 0;
 //BA.debugLineNum = 482;BA.debugLine="Sub moretext_click()";
 //BA.debugLineNum = 483;BA.debugLine="Dim su As StringUtils";
_su = new anywheresoftware.b4a.objects.StringUtils();
 //BA.debugLineNum = 484;BA.debugLine="Dim lener As Int";
_lener = 0;
 //BA.debugLineNum = 485;BA.debugLine="lener = RTLJustify1.Text.Length";
_lener = mostCurrent._rtljustify1.getText().length();
 //BA.debugLineNum = 486;BA.debugLine="Log(lener)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_lener));
 //BA.debugLineNum = 487;BA.debugLine="pnl4_moshakhasat.Height = lener * 0.1%x + 30dip";
mostCurrent._pnl4_moshakhasat.setHeight((int) (_lener*anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0.1),mostCurrent.activityBA)+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))));
 //BA.debugLineNum = 488;BA.debugLine="RTLJustify1.Height = lener * 0.1%x";
mostCurrent._rtljustify1.setHeight((int) (_lener*anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0.1),mostCurrent.activityBA)));
 //BA.debugLineNum = 490;BA.debugLine="moretext.Visible = False";
mostCurrent._moretext.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 491;BA.debugLine="pnl4_line.Visible = False";
mostCurrent._pnl4_line.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 493;BA.debugLine="category_hscrollview.Top = RTLJustify1.Top + RTLJ";
mostCurrent._category_hscrollview.setTop((int) (mostCurrent._rtljustify1.getTop()+mostCurrent._rtljustify1.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20))));
 //BA.debugLineNum = 494;BA.debugLine="scrollview_lastproduct.Top = category_hscrollview";
mostCurrent._scrollview_lastproduct.setTop((int) (mostCurrent._category_hscrollview.getTop()+mostCurrent._category_hscrollview.getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (9))));
 //BA.debugLineNum = 496;BA.debugLine="product_ScrollView.Panel.Height =product_ScrollVi";
...
public static String  _product_scrollview_scrollchanged(int _position) throws Exception{
 ...
 //BA.debugLineNum = 284;BA.debugLine="If Position <= 511 Then";
if (_position<=511) { 
 //BA.debugLineNum = 285;BA.debugLine="product_header.Color = Colors.ARGB(Position/2,25";
mostCurrent._product_header.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (_position/(double)2),(int) (255),(int) (204),(int) (255)));
 ...
 //BA.debugLineNum = 287;BA.debugLine="If Position = 0 Then product_header.Color = Color";
if (_position==0) { 
mostCurrent._product_header.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (255),(int) (255),(int) (255)));};
 //BA.debugLineNum = 289;BA.debugLine="If (Position+83dip) > lbl_title.Top Then";
if ((_position+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (83)))>mostCurrent._lbl_title.getTop()) { 
 //BA.debugLineNum = 290;BA.debugLine="If extra.product_title_flag = False Then extra.p";
...
public static String  _propert_click() throws Exception{
 //BA.debugLineNum = 498;BA.debugLine="Sub propert_click()";
 //BA.debugLineNum = 499;BA.debugLine="StartActivity(property)";
