...
anywheresoftware.b4a.samples.httputils2.httpjob _downloader = null;
 //BA.debugLineNum = 31;BA.debugLine="Sub download_image(id,path,flag)";
 //BA.debugLineNum = 32;BA.debugLine="path= path.Replace(\".jpg\",\"-600x600.jpg\")";
...
_downloader = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 34;BA.debugLine="downloader.Initialize(\"downloadimage*\" & id & \"$\"";
_downloader._initialize((_ba.processBA == null ? _ba : _ba.processBA),"downloadimage*"+_id+"$"+_path+"#"+_flag,(Object)(mostCurrent._index.getObject()));
 //BA.debugLineNum = 35;BA.debugLine="downloader.Download(image_address & path)";
...
float _borderwidth_2 = 0f;
 //BA.debugLineNum = 62;BA.debugLine="Sub InitPanel(pnl As Panel,BorderWidth As Float, F";
 //BA.debugLineNum = 63;BA.debugLine="Dim Rec As Rect";
_rec = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper();
 //BA.debugLineNum = 64;BA.debugLine="Dim Canvas1 As Canvas";
_canvas1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper();
 //BA.debugLineNum = 65;BA.debugLine="Dim BorderWidth_2 As Float";
_borderwidth_2 = 0f;
 //BA.debugLineNum = 66;BA.debugLine="BorderWidth_2=BorderWidth/2";
_borderwidth_2 = (float) (_borderwidth/(double)2);
 //BA.debugLineNum = 67;BA.debugLine="Rec.Initialize(BorderWidth_2,BorderWidth_2,pnl.Wi";
_rec.Initialize((int) (_borderwidth_2),(int) (_borderwidth_2),(int) (_pnl.getWidth()-_borderwidth_2),(int) (_pnl.getHeight()-_borderwidth_2));
 //BA.debugLineNum = 68;BA.debugLine="Canvas1.Initialize(pnl)";
_canvas1.Initialize((android.view.View)(_pnl.getObject()));
 //BA.debugLineNum = 69;BA.debugLine="Canvas1.DrawRect(Rec,FillColor,True,FillColor)";
_canvas1.DrawRect((android.graphics.Rect)(_rec.getObject()),_fillcolor,anywheresoftware.b4a.keywords.Common.True,(float) (_fillcolor));
 //BA.debugLineNum = 70;BA.debugLine="Canvas1.DrawRect(Rec,BorderColor,False,BorderWidt";
...
anywheresoftware.b4a.samples.httputils2.httpjob _load_indexjob = null;
 //BA.debugLineNum = 24;BA.debugLine="Sub load_index()";
 //BA.debugLineNum = 25;BA.debugLine="Log(\"load_index\")";
anywheresoftware.b4a.keywords.Common.Log("load_index");
 //BA.debugLineNum = 26;BA.debugLine="Dim load_indexjob As HttpJob";
_load_indexjob = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 27;BA.debugLine="load_indexjob.Initialize(\"load_indexjob\",index)";
_load_indexjob._initialize((_ba.processBA == null ? _ba : _ba.processBA),"load_indexjob",(Object)(mostCurrent._index.getObject()));
 //BA.debugLineNum = 28;BA.debugLine="load_indexjob.PostString(api,\"op=index\")";
...
anywheresoftware.b4a.samples.httputils2.httpjob _downloader = null;
 //BA.debugLineNum = 37;BA.debugLine="Sub main_download_lastproduct(indexf,image)";
 //BA.debugLineNum = 38;BA.debugLine="Dim downloader As HttpJob";
_downloader = new anywheresoftware.b4a.samples.httputils2.httpjob();
 //BA.debugLineNum = 39;BA.debugLine="downloader.Initialize(\"downloadimglastproc*\" & in";
...
_image_address = "http://itrx.babapkg.ir/image/cache/";
 //BA.debugLineNum = 8;BA.debugLine="Dim image_address_nc As String = \"http://itrx.bab";
_image_address_nc = "http://itrx.babapkg.ir/image/";
 //BA.debugLineNum = 9;BA.debugLine="Dim share_link As String = \"http://itrx.babapkg.i";
_share_link = "http://itrx.babapkg.ir/index.php?route=product/product&product_id=";
 //BA.debugLineNum = 10;BA.debugLine="Dim index_ob_top As Int = 0";
_index_ob_top = (int) (0);
 //BA.debugLineNum = 11;BA.debugLine="Dim index_ob_top_cach As Int =10dip";
_index_ob_top_cach = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10));
 //BA.debugLineNum = 12;BA.debugLine="Dim index_ob_olaviyat(1000) As Int";
_index_ob_olaviyat = new int[(int) (1000)];
;
 //BA.debugLineNum = 13;BA.debugLine="Dim index_ob_olaviyat_load As Int=1";
_index_ob_olaviyat_load = (int) (1);
 //BA.debugLineNum = 14;BA.debugLine="Dim product_id_toshow As Int";
_product_id_toshow = 0;
 //BA.debugLineNum = 15;BA.debugLine="Dim product_title As String";
_product_title = "";
 //BA.debugLineNum = 16;BA.debugLine="Dim product_title_top As Int";
_product_title_top = 0;
 //BA.debugLineNum = 17;BA.debugLine="Dim product_title_flag As Boolean =False";
_product_title_flag = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 18;BA.debugLine="Dim propertyjson As Int = 0";
_propertyjson = (int) (0);
 //BA.debugLineNum = 19;BA.debugLine="Dim procimg_flag As Int = 0";
_procimg_flag = (int) (0);
 //BA.debugLineNum = 20;BA.debugLine="Dim procimg_count(50) As Int";
_procimg_count = new int[(int) (50)];
;
 //BA.debugLineNum = 21;BA.debugLine="Dim flag_procpnl As Int = 0";
_flag_procpnl = (int) (0);
...
anywheresoftware.b4a.objects.IntentWrapper _share = null;
 //BA.debugLineNum = 73;BA.debugLine="Sub programsharepost(id As String)";
 //BA.debugLineNum = 74;BA.debugLine="Dim text As String";
_text = "";
 //BA.debugLineNum = 75;BA.debugLine="text = \"فروشگاه لوازم کودک و سیسمونی مانینی \" & C";
_text = "فروشگاه لوازم کودک و سیسمونی مانینی "+anywheresoftware.b4a.keywords.Common.CRLF+_share_link+_id;
 //BA.debugLineNum = 76;BA.debugLine="Dim share As Intent";
_share = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 77;BA.debugLine="share.Initialize(share.ACTION_SEND,\"\")";
_share.Initialize(_share.ACTION_SEND,"");
 //BA.debugLineNum = 78;BA.debugLine="share.SetType(\"text/plain\")";
_share.SetType("text/plain");
 //BA.debugLineNum = 79;BA.debugLine="share.PutExtra(\"android.intent.extra.TEXT\", text)";
_share.PutExtra("android.intent.extra.TEXT",(Object)(_text));
 //BA.debugLineNum = 80;BA.debugLine="share.WrapAsIntentChooser(\"اشتراک محصول\")";
_share.WrapAsIntentChooser("اشتراک محصول");
 //BA.debugLineNum = 81;BA.debugLine="StartActivity(share)";
